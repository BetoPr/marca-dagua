...
function renderSummary() {
  const d = state.data;
  const cover = d.coverUrl ? `<img src="${escapeHtml(d.coverUrl)}" alt="">` : `<div class="share-summary-noimg"><i data-lucide="image-off"></i> Sem capa</div>`;
...
async function init() {
  ...
  $('limitUpgrade')?.addEventListener('click', () => showToast('Plano Pro chega em breve. Te avisamos no e-mail.'));
