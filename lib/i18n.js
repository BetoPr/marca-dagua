...
const TRANSLATIONS = {
  pt: {
    ...
    'footer.product.gallery': 'Galeria',
    'footer.product.builder': 'Construtor',
    'footer.product.chat': 'Chat IA',
    'footer.product.pro': 'Plano Pro',
    'footer.help': 'Ajuda',
    'footer.help.guide': 'Guia rápido',
    'footer.help.faq': 'FAQ',
    'footer.help.contact': 'Contato',
    'footer.company': 'Empresa',
    'footer.company.terms': 'Termos',
    'footer.company.privacy': 'Privacidade',
    'footer.account': 'Conta',
    'footer.account.signup': 'Criar conta',
    'footer.account.signin': 'Entrar',
    'footer.copyright': '© 2026 Innova & AI Studio',
    'footer.allRights': 'Todos os direitos reservados',

    // Sidebar
    'sidebar.section.main': 'Principal',
    'sidebar.section.tools': 'Ferramentas',
    'sidebar.section.ia': 'IA',
    'sidebar.section.community': 'Comunidade',
    'sidebar.section.system': 'Sistema',
    'sidebar.home': 'Início',
    'sidebar.watermark': "Marca d'água",
    'sidebar.removeBg': 'Remover fundo',
    'sidebar.compress': 'Comprimir',
    'sidebar.convert': 'Converter formato',
    'sidebar.resize': 'Redimensionar',
    'sidebar.chatIa': 'Chat IA',
    'sidebar.builder': 'Construtor',
    'sidebar.imageGen': 'Geração de imagens',
    'sidebar.transcribe': 'Transcrever',
    'sidebar.gallery': 'Galeria',
    'sidebar.share': 'Compartilhar',
    'sidebar.myPrompts': 'Meus prompts',
    'sidebar.favorites': 'Favoritos',
    'sidebar.proPlan': 'Plano Pro',
    'sidebar.subscription': 'Minha assinatura',
    'sidebar.apiKeys': 'Chaves de API',
    'sidebar.soonBadge': 'Em breve',

    // Landing tools cards
    'land.tool.watermark': "Marca d'água em lote",
    'land.tool.removeBg': 'Remover fundo',
    'land.tool.resize': 'Redimensionar pra redes',
    'land.tool.compress': 'Comprimir',
    'land.tool.convert': 'Converter formato',
    'land.tool.chatIa': 'Chat IA (BYOK)',
    'land.tool.builder': 'Construtor de prompts',
    'land.tool.transcribe': 'Transcrever áudio/vídeo',
  },
  ...
  en: {
    ...
    'footer.product.builder': 'Builder',
    'footer.product.chat': 'AI Chat',
    'footer.product.pro': 'Pro plan',
    'footer.help': 'Help',
    'footer.help.guide': 'Quick guide',
    'footer.help.faq': 'FAQ',
    ...
    'land.tool.watermark': 'Batch watermark',
    'land.tool.removeBg': 'Remove background',
    'land.tool.resize': 'Resize for socials',
    'land.tool.compress': 'Compress',
    'land.tool.convert': 'Convert format',
    'land.tool.chatIa': 'AI Chat (BYOK)',
    'land.tool.builder': 'Prompt builder',
    'land.tool.transcribe': 'Transcribe audio/video',
  },
  ...
  es: {
    ...
    'footer.product.gallery': 'Galería',
    'footer.product.builder': 'Constructor',
    'footer.product.chat': 'Chat IA',
    'footer.product.pro': 'Plan Pro',
    'footer.help': 'Ayuda',
    'footer.help.guide': 'Guía rápida',
    'footer.help.faq': 'FAQ',
    ...
    'footer.account.signup': 'Crear cuenta',
    'footer.account.signin': 'Iniciar sesión',
    'footer.copyright': '© 2026 Innova & AI Studio',
    ...
    'sidebar.removeBg': 'Quitar fondo',
    'sidebar.compress': 'Comprimir',
    'sidebar.convert': 'Convertir formato',
    'sidebar.resize': 'Redimensionar',
    'sidebar.chatIa': 'Chat IA',
    'sidebar.builder': 'Constructor',
    'sidebar.imageGen': 'Generación de imágenes',
    'sidebar.transcribe': 'Transcribir',
    'sidebar.gallery': 'Galería',
    'sidebar.share': 'Compartir',
    'sidebar.myPrompts': 'Mis prompts',
    'sidebar.favorites': 'Favoritos',
    'sidebar.proPlan': 'Plan Pro',
    'sidebar.subscription': 'Mi suscripción',
    'sidebar.apiKeys': 'Claves de API',
    'sidebar.soonBadge': 'Próximamente',

    'land.tool.watermark': 'Marca de agua en lote',
    'land.tool.removeBg': 'Quitar fondo',
    'land.tool.resize': 'Redimensionar para redes',
    'land.tool.compress': 'Comprimir',
    'land.tool.convert': 'Convertir formato',
    'land.tool.chatIa': 'Chat IA (BYOK)',
    'land.tool.builder': 'Constructor de prompts',
    'land.tool.transcribe': 'Transcribir audio/video',
  },
};
